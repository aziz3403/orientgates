...
function ShareButtons({ title }: { title: string }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <button onClick={copyLink} className="flex items-center gap-2 text-[9px] tracking-[0.2em] uppercase text-warm-gray/70 hover:text-ivory transition-colors font-sans">
      ...
      <a
        ...
        className="flex items-center gap-2 text-[9px] tracking-[0.2em] uppercase text-warm-gray/70 hover:text-ivory transition-colors font-sans"
      >
        ...
        <div className="px-5 pb-6 space-y-4 border-t border-white/[0.04] pt-5">
          {[
            ...
            <div key={item.title}>
              ...
              <p className="text-[11px] text-warm-gray/70 leading-relaxed font-sans">{item.text}</p>
            </div>
          ))}
        </div>
      )}
      ...
      <div className="bg-midnight pt-36 pb-6">
        <div className="max-w-[1800px] mx-auto px-6 lg:px-16">
          <div className="flex items-center gap-2 text-[9px] tracking-[0.25em] uppercase text-warm-gray/70 font-sans flex-wrap">
            ...
            <span className="text-pearl/60 truncate max-w-[200px]">{product.title}</span>
          </div>
        </div>
      </div>
              ...
              <AnimateIn>
                ...
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 border transition-all duration-300 ${wishlisted ? "border-brass/30 text-brass" : "border-white/10 text-warm-gray/70 hover:text-ivory hover:border-white/20"}`}
                  >
                ...
                <div className="space-y-5 mb-10">
                  {[
                    ...
                    <div key={d.label} className="flex justify-between items-start gap-6">
                      <span className="text-[9px] tracking-[0.3em] uppercase text-warm-gray/70 whitespace-nowrap font-sans pt-0.5">{d.label}</span>
                ...
                <div className="space-y-10">
                  ...
                  <div>
                    ...
                    {product.restorationHistory && (
                      <div className="mt-4 p-4 border border-white/[0.04] bg-white/[0.01]">
                        ...
                        <p className="text-[12px] text-warm-gray/80 leading-relaxed font-sans">{product.restorationHistory}</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-ivory/75 leading-[1.8] font-sans italic">{product.provenance}</p>
                  </div>
                        ...
                        {product.auctionHistory.map((record, i) => (
                          <div key={i} className="flex items-start justify-between p-4 border border-white/[0.04] bg-white/[0.01]">
                            <div>
                              ...
                              {record.lot && <span className="text-[11px] text-warm-gray/70 font-sans ml-2">— {record.lot}</span>}
                            </div>
                            <div className="text-right">
                              <span className="text-[12px] text-warm-gray/80 font-sans">{record.date}</span>
                  ...
                  {product.exhibitionHistory && (
                    <div>
                      ...
                      <p className="text-[12px] text-warm-gray/80 leading-relaxed font-sans">{product.exhibitionHistory}</p>
                    </div>
                  )}
                  ...
                  {product.literatureReferences && (
                    <div>
                      ...
                      <p className="text-[12px] text-warm-gray/80 leading-relaxed font-sans italic">{product.literatureReferences}</p>
                    </div>
                  )}
                  ...
                  {product.comparableSales && (
                    <div>
                      ...
                      <p className="text-[12px] text-warm-gray/80 leading-relaxed font-sans">{product.comparableSales}</p>
                    </div>
                  )}
                  ...
                  {(product.shipping || product.insurance) && (
                    <div>
                      ...
                      {product.shipping && <p className="text-[12px] text-warm-gray/80 leading-relaxed font-sans mb-2">{product.shipping}</p>}
                      {product.insurance && <p className="text-[12px] text-warm-gray/80 leading-relaxed font-sans">{product.insurance}</p>}
                    </div>
                  )}
                </div>
