...
export const metadata: Metadata = {
  ...
  description:
    "The latest additions to our collection of rare antiques and Levantine mother-of-pearl furniture — freshly sourced pieces available for acquisition or private inquiry.",
